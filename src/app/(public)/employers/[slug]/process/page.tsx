...
export async function generateMetadata({
    ...
    try {
        ...
        const title = `${employer.name} — Hiring Process & Assessment Guide`;
        const description = `Step-by-step breakdown of ${employer.name}'s graduate recruitment process, assessment stages, and preparation tips.`;
        const url = absoluteUrl(`/employers/${employer.slug}/process`);
...
export default async function EmployerProcessPage({
    ...
    const breadcrumbs = breadcrumbSchema([
        ...
        {
            name: "Process",
            url: absoluteUrl(`/employers/${employer.slug}/process`),
        },
    ]);
